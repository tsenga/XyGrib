...
QString styleSheetDef = // MainWindow
        "QDockWidget#BoardPanel QFrame {color: #ffffff; background: #666666} "
        "QWidget#MeteoHeader QFrame { color: #ffffff; background-color: #666666; } "
        "QStatusBar,QScrollBar,QDialog,QMainWindow {color: #ffffff; background: #666666} "
...
QString meteoTableStyleSheetDef = // MeteoTableDialog
        "#mtd, QScrollBar {color: #ffffff; background-color: #666666;} "
